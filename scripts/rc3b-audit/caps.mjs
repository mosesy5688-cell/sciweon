...
export const IMMUTABLE_CAPS = Object.freeze({
    ...
    MAX_GET_LOCATOR_REQUESTS_PER_RUN: 16,
    MAX_LOCATOR_SPECS_PER_RUN: 64,
    MAX_LOCATOR_VALUES_PER_RUN: 64,
    MAX_LOCATOR_VALUE_BYTES_SINGLE: 512,
    MAX_LOCATOR_VALUE_BYTES_TOTAL: 8192,
